...
def drive_boat(frame):
    ...
    lower_red_or_purple = np.array([130, 50, 50])
    upper_red_or_purple = np.array([160, 255, 255])
    mask_red_or_purple = cv2.inRange(hsv, lower_red_or_purple, upper_red_or_purple)
