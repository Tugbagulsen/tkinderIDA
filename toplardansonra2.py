            ...
            if ret:
                ...
                def gemi_görüyor_fn(red_center, green_center, yellow_center, orjin,gemi_uyarısı_metin):
                    ...
                    if yellow_in_range and green_in_range and red_in_range:
                        ...
                        return "sarı ve yeşili görüyorum"
                    elif red_in_range and yellow_in_range:
                        return "kırmızı ve sarıyı görüyorum"
                    elif red_in_range:
                        return "kırmızı topu görüyorum"
                    elif yellow_in_range:
                        return "sarı topu görüyorum" + sag_yon
                    elif green_in_range:
                        return "yeşil topu görüyorum"
                    else:
                ...
                öneri3_metin =toplardansonra(gemi_görüyor_fn,orjin,red_center,öneri3_metin)
                öneri1_metin= öneri1_fn(x,orjin)
                öneri2_metin= öneri1_fn(a,orjin)
